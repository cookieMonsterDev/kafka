 ...
 *
 * Bumped from 156 KB to 166 KB for the `react`/`react-dom`/`lucide-react`/`tailwind-merge`
 * dependency updates, which moved the measured baseline to ~162.7 KB gzip.
 */
const INITIAL_JS_BUDGET_BYTES = 166 * 1024;
