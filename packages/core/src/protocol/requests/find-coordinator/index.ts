...
const VERSIONS: Readonly<Record<number, ProtocolFactory<FindCoordinatorOptions>>> = {
  ...
  1: (options) => {
    ...
    return {
      request: findCoordinatorRequestV1({ coordinatorKey: options.coordinatorKey, coordinatorType: options.coordinatorType }),
  ...
  2: (options) => {
    ...
    return {
      request: findCoordinatorRequestV2({ coordinatorKey: options.coordinatorKey, coordinatorType: options.coordinatorType }),
