...
const VERSIONS: Readonly<Record<number, ProtocolFactory<FetchRequestOptions>>> = {
  0: (options) => fetchProtocol(fetchRequestV0(options), fetchResponseV0(options), options.maxWaitTime),
  1: (options) => fetchProtocol(fetchRequestV1(options), fetchResponseV1(options), options.maxWaitTime),
  2: (options) => fetchProtocol(fetchRequestV2(options), fetchResponseV2(options), options.maxWaitTime),
  3: (options) => fetchProtocol(fetchRequestV3(options), fetchResponseV3(options), options.maxWaitTime),
  4: (options) => fetchProtocol(fetchRequestV4(options), fetchResponseV4(options), options.maxWaitTime),
  5: (options) => fetchProtocol(fetchRequestV5(options), fetchResponseV5(options), options.maxWaitTime),
  6: (options) => fetchProtocol(fetchRequestV6(options), fetchResponseV6(options), options.maxWaitTime),
  7: (options) => fetchProtocol(fetchRequestV7(options), fetchResponseV7(options), options.maxWaitTime),
  8: (options) => fetchProtocol(fetchRequestV8(options), fetchResponseV8(options), options.maxWaitTime),
  9: (options) => fetchProtocol(fetchRequestV9(options), fetchResponseV9(options), options.maxWaitTime),
  10: (options) => fetchProtocol(fetchRequestV10(options), fetchResponseV10(options), options.maxWaitTime),
  11: (options) => fetchProtocol(fetchRequestV11(options), fetchResponseV11(options), options.maxWaitTime),
  12: (options) => fetchProtocol(fetchRequestV12(options), fetchResponseV12(options), options.maxWaitTime),
