 ...
 *
 * Bumped from 156 KB to 163 KB for the `zod`/`@tanstack/react-router`/`@tanstack/react-virtual`
 * dependency updates, which moved the measured baseline to ~160.2 KB gzip.
 */
const INITIAL_JS_BUDGET_BYTES = 163 * 1024;
