...
import { createSaslAuthenticator } from '../../src/broker/sasl-authenticator/index.js';
import { Cluster } from '../../src/cluster/index.js';
import type { ClusterOptions } from '../../src/cluster/index.js';
...
import { ConnectionPool } from '../../src/network/connection-pool.js';
import type { ConnectionOptions } from '../../src/network/connection.js';
import { createDefaultSocketFactory } from '../../src/network/socket-factory.js';
import { FAST_RETRY_DEFAULTS } from '../../src/retry/test-defaults.js';
import type { KafkaConfig } from '../../src/types/index.js';
import type { CustomPartitioner } from '../../src/producer/types.js';
import { waitFor } from '../../src/utils/wait.js';
