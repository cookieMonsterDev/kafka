...
export const ADMIN_METHOD_CLASSIFICATION: Record<AdminMethodName, MethodClassification> = {
  ...
  describeProducers: 'passthrough-only',
  deleteTopicRecords: 'passthrough-only',
  fetchOffsets: 'passthrough-only',
  fetchTopicOffsets: 'passthrough-only',
  fetchTopicOffsetsByTimestamp: 'passthrough-only',
  setOffsets: 'passthrough-only',
  resetOffsets: 'passthrough-only',
  describeConfigs: 'passthrough-only',
  ...
  deleteGroups: 'passthrough-only',
  deleteGroupOffsets: 'passthrough-only',
  removeMembersFromConsumerGroup: 'passthrough-only',
  ...
  createAcls: 'passthrough-only',
  describeAcls: 'passthrough-only',
  ...
  listConfigResources: 'passthrough-only',
