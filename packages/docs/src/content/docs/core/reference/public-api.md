...
| `Partitioners`                                                                        | `DefaultPartitioner`, `LegacyPartitioner`, `StickyPartitioner` (`JavaCompatiblePartitioner` is a deprecated alias of `DefaultPartitioner`, removed in the next major) | [Producer](../../guides/producer/#partitioners)            |
