...
import type { MetadataResponseV10Body } from '../v10/response';

export type MetadataResponseV11Body = Omit<MetadataResponseV10Body, 'clusterAuthorizedOperations'>;
 ...
 *
 * Drops `clusterAuthorizedOperations` (KIP-700). Topic `name` is still non-null. Throttle
 * semantics stay the v6/KIP-219 client-side meaning.
 *
...
export const metadataResponseV11: ResponseDefinition<MetadataResponseV11Body> = {
