...
| Shell invocation                                                                                 | CLI equivalent                                                                                                                                                                               |
| ------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `--list`                                                                                         | `kafka group list` — `--state`/`--type` filters have **no direct equivalent**; the command always lists every group                                                                          |
| `--describe --group G`                                                                           | `kafka group describe G` — always shows state, protocol, and members (no `--members` flag needed); `--offsets` is the separate `kafka group offsets G`; `--state`'s filter has no equivalent |
