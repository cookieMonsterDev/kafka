...
export const ADMIN_METHOD_CLASSIFICATION: Record<AdminMethodName, MethodClassification> = {
  ...
  describeShareGroups: 'mounted',
  listShareGroupOffsets: 'mounted',
  alterShareGroupOffsets: 'mounted',
  deleteShareGroupOffsets: 'mounted',
  deleteShareGroups: 'mounted',
  createAcls: 'mounted',
  describeAcls: 'mounted',
  deleteAcls: 'mounted',
  alterPartitionReassignments: 'mounted',
  listPartitionReassignments: 'mounted',
  electLeaders: 'mounted',
  describeUserScramCredentials: 'mounted',
  alterUserScramCredentials: 'mounted',
  describeClientQuotas: 'mounted',
  alterClientQuotas: 'mounted',
  describeLogDirs: 'mounted',
  describeReplicaLogDirs: 'passthrough-only',
  alterReplicaLogDirs: 'passthrough-only',
  updateFeatures: 'mounted',
  describeFeatures: 'mounted',
  describeMetadataQuorum: 'mounted',
  unregisterBroker: 'mounted',
  assignReplicasToDirs: 'passthrough-only',
  addRaftVoter: 'mounted',
  removeRaftVoter: 'mounted',
  listConfigResources: 'mounted',
  describeTransactions: 'mounted',
  listTransactions: 'mounted',
  fenceProducers: 'mounted',
  abortTransaction: 'mounted',
  forceTerminateTransaction: 'mounted',
  createDelegationToken: 'mounted',
  renewDelegationToken: 'mounted',
  expireDelegationToken: 'mounted',
  describeDelegationToken: 'mounted',
};
