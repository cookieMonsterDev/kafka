...
import { heartbeatTopicPartitionsSchema, type ConsumerGroupHeartbeatTopicPartitions } from '../shared';

export interface ConsumerGroupHeartbeatAssignment {
  topicPartitions: ConsumerGroupHeartbeatTopicPartitions[];
}

export interface ConsumerGroupHeartbeatResponseV0Body {
  throttleTime: number;
  ...
  assignment: ConsumerGroupHeartbeatAssignment | null;
}

/**
 * ConsumerGroupHeartbeat Response (Version: 0) => throttle_time_ms error_code error_message
...
export const consumerGroupHeartbeatResponseV0: ResponseDefinition<ConsumerGroupHeartbeatResponseV0Body> = {
