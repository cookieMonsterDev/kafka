...
import { produceRequestV4 } from './request.js';
          ...
          messages: [
            {
              ...
              value: 'some-value-01e05f8db1f05f560a4e-99758-5522807d-67a8-4331-af74-49700cfa36f2',
            ...
            },
            {
              ...
              value: 'some-value-96d540560a76c83ed675-99758-b23ddac7-521c-417b-8cc3-043d3b709c9f',
              timestamp: 1509928155660,
              headers: {
            ...
            },
            {
              ...
              value: 'some-value-ed896f5001b143a3405d-99758-40566a64-7f6f-45c0-b983-54e5640b6dc0',
              timestamp: 1509928155660,
              headers: {
...
describe('protocol/requests/produce/v4/request', () => {
  it('sets expectResponse to false when acks=0', () => {
    expect(produceRequestV4({ ...args, acks: 0 }).expectResponse?.()).toBe(false);
  });

  it('encodes a request matching a real kafkajs fixture', async () => {
    const encoder = await produceRequestV4(args).encode();
