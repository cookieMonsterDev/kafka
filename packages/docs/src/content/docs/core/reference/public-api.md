...
| `CompressionCodecs`                                                                   | Codec registry; GZIP, LZ4, and ZSTD built in                                                |                                                         |
...
Snappy is a pluggable stub, not built in.
...
- Built-in LZ4 (`CompressionTypes.LZ4`) and ZSTD (`CompressionTypes.ZSTD`)
