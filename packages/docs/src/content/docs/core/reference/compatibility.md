...
The client talks to **4.0 and 4.3** via overlap (Produce 3–10, Fetch 4–18,
...
each topic). Fetch v13+ addresses topics by those IDs; earlier Fetch versions
and Produce still use topic names.
